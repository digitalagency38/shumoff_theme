...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<div class="cart_block__blocks">
		...
		<?php
			...
			?>
		<div class="cart_block__block woocommerce-cart-form__cart-item cart_item">
			<div class="cart_block__block--info">
				<?php
						...
						?>
				<div class="cart_block__block--tit">
					<?php
							if ( ! $product_permalink ) {
			...
			<div class="cart_block__block--price">
				<div class="cart_block__block--item">
			...
			<div class="cart_block__block--price">
				<div class="cart_block__block--item"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?>:</div><span>
					<?php
							echo apply_filters( 'woocommerce_cart_item_subtotal', WC()->cart->get_product_subtotal( $_product, $cart_item['quantity'] ), $cart_item, $cart_item_key ); // PHPCS: XSS ok.
						?>
				</span>
			</div>
			<div class="cart_block__block--del">
				<?php
