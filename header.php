		...
		<header class="header">
			<div class="header__in center_block">
				<div class="header__top">
					...
					<? the_custom_logo(); ?>
					<div class="header__cat-btn isOpen button button__all-link" v-if="sizes.window > 1023">
					...
					<div class="header__cat-btn isClose isHide button button__all-link" v-if="sizes.window > 1023">
						<svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
			...
			<div class="header__cat" v-if="sizes.window > 1023">
